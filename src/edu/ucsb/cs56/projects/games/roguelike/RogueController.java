...
public class RogueController extends JFrame implements KeyListener
{
    ...
    */
    ...
    public void keyPressed(KeyEvent key) {
        ...
        case 'w':
        case '8':
            this.y = this.y - player.getSpeed();
            break;
        case 'a':
        case '4':
            this.x = this.x - player.getSpeed();
            break;
        case 'd':
        case '6':
            this.x = this.x + player.getSpeed();
        ...
        case '9'/*up*/	  :
            this.y = this.y - player.getSpeed();
            /*right*/ 	 this.x = this.x + player.getSpeed();
            break;
        case '7'/*up*/	  :
            this.y = this.y - player.getSpeed();
            /*left*/     this.x = this.x - player.getSpeed();
            break;
        case '1'/*down*/  :
            this.y = this.y + player.getSpeed();
            /*left*/     this.x = this.x - player.getSpeed();
